...
local SkillchainTable = {
    ...
    [18] = { property = 'Fusion - Naked', elements = 'Fire / Light' },
    [19] = { property = 'Gravitation - Naked', elements = 'Earth / Dark' },
    [20] = { property = 'Fragmentation - Naked', elements = 'Wind / Lightning' },
    [21] = { property = 'Distortion - Naked', elements = 'Water / Ice' },
};
